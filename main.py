...
with col1:
    ...
    upload_to_index = st.radio("Setup your VectorDB ",
                               ("Create a new Pinecone index with pdf files",
                                ...
                                index=None)
    if upload_to_index == "Create a new Pinecone index with pdf files":
    ...
    llm_choice = st.selectbox("Select your LLM model:", ["Hugging Face", "Google Gemini", "OpenAI"], index=None)
